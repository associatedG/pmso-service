# Generated by Django 5.0.8 on 2024-08-13 06:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region='VN')),
                ('tier', models.CharField(choices=[('T1', 'Cấp độ 1'), ('T2', 'Cấp độ 2'), ('T3', 'Cấp độ 3')], default='T1', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='customer_orders', to='products.customer')),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Open', 'Mở'), ('Planning Production', 'Lên Kế Hoạch Sản Xuất'), ('In Production', 'Đang Sản Xuất'), ('Delivering', 'Giao Hàng'), ('Completed', 'Hoàn Thành'), ('Cancelled', 'Cancelled')], default='Open', max_length=50)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
